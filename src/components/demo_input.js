...
var style = {
  uploadIcon: {
    ...
    height: "90px",
    background:
      "linear-gradient(90deg, rgba(33,130,254,1) 0%, rgba(141,95,250,1) 37%, rgba(161,89,249,1) 71%, rgba(226,68,247,1) 100%)",
  },
  titleText: {
    fontWeight: "600",
    color: "#ffffff",
      ...
      <div className="container">
        <div className="row align-items-center ">
          <div className="col-sm-6 offset-md-3">
            <h2
              className="text-left mb-4 text-center"
              style={{
                color: "#fff",
                fontFamily: "Arial, Helvetica, sans-serif",
              }}
            >
              Upload X-ray image to see result
            </h2>
            <span
              style={{
                color: "#ff0000",
            ...
            <div className="contact-form">
              ...
              >
                ...
                <div style={style.titleText}>Upload PDF File Only</div>
              ...
              >
                <Stack>
                  ...
                  {/* {image && (
                    <img
                      src={image}
                      style={{ width: 180, height: 200, marginTop: 20 }}
                    />
                  )} */}
                  <b style={{ color: "#fff" }}>
                    {fileName != "" ? fileName : ""}
